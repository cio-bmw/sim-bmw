...
function loadData(){ 
  ...
  $.ajax({ 
    url: "category_lov.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
$(function(){  
 ...
 function sendcategory(n1,n2) 
 {
        document.getElementById('category_idcat').value=n1;
        document.getElementById('catname').value=n2;
     $('#divLOV').hide();
 } 
</script> 
...
$fieldcari = $_POST['fieldcari']; 
  ...
  $sql = "select * from category where idcat like '%".$fieldcari."%'";  
...
<th>margin</th>
       ...
       <tr> 
 <td><? echo $row['idcat'];?></td>
<td><? echo $row['catname'];?></td>

 
<td><input class="button" type=button value="Pilih" onClick="sendcategory('<? echo $row['idcat'];?>','<? echo $row['catname'];?>  ' )"></td>
  		<?} //end while ?> 
