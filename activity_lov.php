...
function loadData(){ 
  ...
  $.ajax({ 
    url: "activity_lov.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
$(function(){  
  ...
  $("#btncari").click(function(){  
  		page1="activity_lov.php?cari="+$("input#carilov").val();  
  		$("#divLOV").load(page1);  
  		$("#divLOV").show();  
     	return false;  
  	});   
 ...
 function sendactivity(n1,n2) 
 {
     document.getElementById('activity_idactivity').value=n1;
     document.getElementById('activity').value=n2;
 } 
</script> 
...
$cari = $_GET['cari']; 
  ...
  $sql = "select * from activity where idactivity like '%".$cari."%'";  
...
?> 
	...
	<body> 
	<p class="judul">Daftar activity</p>  
	<p>
	<form method="post" name="activity_lov" action="" id="activity_lov">  
 ...
 <th>idactivity</th>
<th>activity</th>
<th>soptype_idsoptype</th>
<th>unitact_idunitact</th>
<th>Aksi</th> 
  </tr> 
		<?php 
...
<td><input class="button" type=button value="Pilih" onClick="sendactivity('<? echo $row['idactivity'];?>','<? echo $row['activity'];?>  ' )"></td>
  		<?} //end while ?> 
