...
<td><? echo $row['txnvalue'];?></td>
        ...
        <td><a href="cashin_form.php?action=update&id=<? echo $row['idcashin'];?>" class="edit"> <input type="button" class="button" value="Edit"></a>   
       | <a href="cashin_process.php?action=delete&id=<? echo $row['idcashin'];?>" class="delete"><input type="button" class="button" value="Delete"></a></td></tr> 
  		<?} //end while ?> 
