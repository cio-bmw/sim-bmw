...
<script type="text/javascript" src="js/stocklocproduct.js"></script> 
</head> 
<body> 
<table class="white">
<tr><td class="white"><img src="images/logo.png"></td></tr>
<tr><td class="judul">Data stocklocproduct</td></tr>
</table>
<div id="divSearch"> 
  <form id="formSearch"> 
  <table><tr> 
  <td>Cari Berdasarkan</td><td><select id="pilihcari">  
      <option value="qtystock">qtystock</option> 
      <option value="product_idproduct">product_idproduct</option> 
      <option value="stockloc_idstockloc">stockloc_idstockloc</option> 
