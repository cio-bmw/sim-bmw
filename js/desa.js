$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
    ...
    else if ($(this).val() == "desaname"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "kecamatan_idkec"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "iddesa"){ 
      dataString = 'iddesa='+ cari;  
   } 
   else if (combo == "desaname"){ 
      dataString = 'desaname='+ cari; 
    } 
   else if (combo == "kecamatan_idkec"){ 
      dataString = 'kecamatan_idkec='+ cari; 
    } 
 
   $.ajax({ 
     url: "desa_display.php", 
     type: "GET", 
     data: dataString, 
