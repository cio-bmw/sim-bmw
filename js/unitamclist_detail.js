$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="unitamclist_form.php"; 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="unitamclist_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
    ...
    else if ($(this).val() == "amclist_idamclist"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data unitamclist 
	loadData(); 
 ...
 $("form#unitamclist").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
