$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="historypayment_form.php?id="+$("input#idhistorypayment").val(); 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="historypayment_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
   
		page3="historypayment_display.php?id="+$("input#idhistorypayment").val(); 
	...
	$("#btnlist").click(function(){ 
		window.location='historypayment.php'; 
	}); 
	 
		$("#btncetak").click(function(){ 
		window.open("historypayment_pdf.php?id="+$("input#idhistorypayment").val(), "_blank");
		}); 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("historypayment_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
	...
	//menampilkan list data historypayment 
	loadData(); 
 ...
 $("form#historypayment_detail").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
