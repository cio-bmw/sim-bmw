$(document).ready(function(){ 
  ...
  $("#btnsum").click(function(){ 
 		page="receivehdr_dailysummary.php?startdate="+$("input#startdate").val()+"&enddate="+$("input#enddate").val(); 
	...
	$("#btncetak").click(function(){ 
     ...
     window.open('receivehdr_rekappdf.php?startdate='+vstart+'&enddate='+vend,"_blank");
 ...
 dataString = 'idsupp='+vidsupp+'&startdate='+vstartdate+'&enddate='+venddate+'&model='+vmodel; 
   ...
   $.ajax({ 
     url: "receivehdr_suppliersummary.php", 
     type: "GET", 
     data: dataString, 
