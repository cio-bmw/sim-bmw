$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="project_form.php?id="+$("input#idproject").val(); 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="project_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
   
		page3="project_display.php?id="+$("input#idproject").val(); 
...
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("project_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
 ...
 $("form#project_detail").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
