$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="prospekflow_form.php?id="+$("input#idprospekflow").val(); 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="prospekflow_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
   
		page3="prospekflow_display.php?id="+$("input#idprospekflow").val(); 
	...
	$("#btnlist").click(function(){ 
		window.location='prospekflow.php'; 
	}); 
	 
		$("#btncetak").click(function(){ 
		window.open("prospekflow_pdf.php?id="+$("input#idprospekflow").val(), "_blank");
		}); 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("prospekflow_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idprospekflow"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "prospekflow"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "dateflow"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "prospek_idprospek"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data prospekflow 
	loadData(); 
 ...
 $("form#prospekflow_detail").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
