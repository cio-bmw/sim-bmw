$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		...
		page2="receive_paymentdtl_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
	...
	$("#btnlist").click(function(){ 
		window.location='receive_paymentdtl.php'; 
	}); 
	 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("receive_paymentdtl_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
    ...
    else if ($(this).val() == "receivehdr_idreceivehdr"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "receive_paymenthdr_idpaymenthdr"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data receive_paymentdtl 
	loadData(); 
 ...
 $("form#receive_paymentdtl").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
