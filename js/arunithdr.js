$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
	...
	//menampilkan list data arunithdr 
	loadData(); 
	 
  // fungsi untuk me-load tampilan list data arunithdr, data yang ditampilkan disesuaikan 
