...
//		$("#divPageData").show(); 
	...
	//menampilkan list data kprcheckhdr 
	loadData(); 
 ...
 $("form#kprcheckhdr").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
