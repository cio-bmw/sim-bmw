$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="todo_form.php?id="+$("input#idtodo").val(); 
		...
		page3="todo_display.php?id="+$("input#idtodo").val(); 
...
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("todo_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
 ...
 $("form#todo_detail").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
