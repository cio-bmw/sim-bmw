$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
			page="tipe_materialbudget_form.php?idtipe="+$('input#idtiped').val(); 
		$("#divPageEntry").load(page); 
		$("#divPageEntry").show(); 

		page1="tipe_materialbudget_dspproduct.php?idtipe="+$('input#idtiped').val(); 
		$("#divLOV").load(page1); 
		$("#divLOV").show(); 


		page2="tipe_materialbudget_display.php?idtipe="+$('input#idtiped').val(); 
	...
	page2="tipe_materialbudget_impform.php?idtipe="+$('input#idtiped').val(); 
		$("#divPageData").load(page2); 
		$("#divPageData").show(); 
		return false; 
	...
	//menampilkan list data tipe_materialbudget 
	loadData(); 
  ...
  function loadData(){ 
	  var dataString; 
	  var vtipe = $("input#idtipe").val(); 
	  
      dataString = 'idtipe='+ vtipe; 
