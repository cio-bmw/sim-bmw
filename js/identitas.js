$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "ididentitas"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "clientname"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    ...
    else if ($(this).val() == "keynumber"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "serial"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "simrspic"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "ididentitas"){ 
      dataString = 'ididentitas='+ cari;  
   } 
   else if (combo == "clientname"){ 
      dataString = 'clientname='+ cari; 
    } 
   else if (combo == "address"){ 
      dataString = 'address='+ cari; 
    } 
   else if (combo == "city"){ 
      dataString = 'city='+ cari; 
    } 
   else if (combo == "phone"){ 
   ...
   else if (combo == "keynumber"){ 
      dataString = 'keynumber='+ cari; 
    } 
   else if (combo == "serial"){ 
      dataString = 'serial='+ cari; 
    } 
   else if (combo == "simrspic"){ 
      dataString = 'simrspic='+ cari; 
    } 
 
   $.ajax({ 
     url: "identitas_display.php", 
     type: "GET", 
     data: dataString, 
