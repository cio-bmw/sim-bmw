$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="activity_form.php?id="+$("input#idactivity").val(); 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="activity_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
   
		page3="activity_display.php?id="+$("input#idactivity").val(); 
	...
	$("#btnlist").click(function(){ 
		...
		window.open("activity_pdf.php?id="+$("input#idactivity").val(), "_blank");
		}); 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("activity_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
    ...
    else if ($(this).val() == "soptype_idsoptype"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "unitact_idunitact"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
