$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		...
		page2="spkpaymenthdr_lovspk.php?contractor="+$("input#contractor_idcontractor").val(); 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
   
		page3="spkpaymentdtl_displaymini.php?id="+$("input#idspkpaymenthdr").val(); 
	...
	$("#btnlist").click(function(){ 
		window.location='spkpaymenthdr.php'; 
	}); 
	...
	window.open("spkpaymentdtl_pdf.php?id="+$("input#idspkpaymenthdr").val(), "_blank");
	}); 
	 
	//menangani jika user melakukan pilihan pada combo #pilihcari 
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idspkpaymenthdr"){ 
  	  $("td#kolompilih").show(); 
	...
	//menampilkan list data spkpaymenthdr 
	loadData(); 
