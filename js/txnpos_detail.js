$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="txnpos_form.php"; 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="txnpos_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
	...
	$("#btnlist").click(function(){ 
		window.location='txnpos.php'; 
	}); 
	 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("txnpos_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idtxnpos"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "posname"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
