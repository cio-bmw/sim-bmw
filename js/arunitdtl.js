$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
    ...
    else if ($(this).val() == "arunithdr_idarunithdr"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data arunitdtl 
	loadData(); 
	 
  // fungsi untuk me-load tampilan list data arunitdtl, data yang ditampilkan disesuaikan 
  ...
  function loadData(){ 
   ...
   else if (combo == "arunithdr_idarunithdr"){ 
      dataString = 'arunithdr_idarunithdr='+ cari; 
    } 
