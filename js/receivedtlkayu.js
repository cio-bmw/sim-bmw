$(document).ready(function(){ 
  ...
  $("#btnrcvdtl").click(function(){ 
      var cari = $("input#idreceivehdr").val(); 
  		page="receivedtlkayu_display.php?id="+cari;
	...
	$("#btnlist").click(function(){ 
		window.location='receivehdrkayu.php'; 
	}); 
	
 $("#btnaddproduct").click(function(){ 
  var cari = $("input#idreceivehdr").val(); 
		page="receivedtlkayu_form.php?id="+cari; 
		$("#divPageEntry").load(page); 
		$("#divPageEntry").show(); 
		//$("#btnhide").show(); 
		page1="receivedtlkayu_dspproduct.php?id="+cari; 
		$("#divLOV").load(page1); 
		$("#divLOV").show(); 
		//$("#btnhide").show(); 
		page2="receivedtlkayu_displaymini.php?id="+cari;
	...
	window.open('receivedtlkayu_pdf.php?id='+$("input#idreceivehdr").val(),'_blank');
	}); 
    ...
    window.open('receivehdrkayu_reopen.php?id='+$("input#idreceivehdr").val(),'_blank');	 }
    else {
