$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="groupacc_form.php"; 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="groupacc_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
	...
	$("#btnlist").click(function(){ 
		window.location='groupacc.php'; 
	}); 
	 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("groupacc_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idgroupacc"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "groupname"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data groupacc 
	loadData(); 
