$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
    ...
    else if ($(this).val() == "riothers_desc"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "riothers_price"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "riothers_qty"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idriothers"){ 
      dataString = 'idriothers='+ cari;  
   } 
   else if (combo == "txn_date"){ 
      dataString = 'txn_date='+ cari; 
    } 
   else if (combo == "riothers_desc"){ 
      dataString = 'riothers_desc='+ cari; 
    } 
   else if (combo == "riothers_price"){ 
      dataString = 'riothers_price='+ cari; 
    } 
   else if (combo == "riothers_qty"){ 
      dataString = 'riothers_qty='+ cari; 
    } 
