$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
    ...
    else if ($(this).val() == "tarifpoli"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "vvip"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    ...
    else if ($(this).val() == "kelas1"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "kelas2"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "kelas3"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "iddr"){ 
      dataString = 'iddr='+ cari;  
   } 
   else if (combo == "drname"){ 
      dataString = 'drname='+ cari; 
    } 
   ...
   else if (combo == "tarifpoli"){ 
      dataString = 'tarifpoli='+ cari; 
    } 
   else if (combo == "vvip"){ 
      dataString = 'vvip='+ cari; 
    } 
   else if (combo == "vip"){ 
      dataString = 'vip='+ cari; 
    } 
   else if (combo == "kelas1"){ 
      dataString = 'kelas1='+ cari; 
    } 
   else if (combo == "kelas2"){ 
      dataString = 'kelas2='+ cari; 
    } 
   else if (combo == "kelas3"){ 
      dataString = 'kelas3='+ cari; 
    } 
 
   $.ajax({ 
     url: "dokter_display.php", 
     type: "GET", 
     data: dataString, 
