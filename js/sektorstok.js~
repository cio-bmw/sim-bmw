$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
	...
	//menampilkan list data sektorstok 
	loadData(); 
  ...
  function loadData(){
	  ...
	  var vproduct = $("input#fieldcari").val(); 
	  
	  
     dataString = 'sektor='+ cari + '&product='+vproduct  ; 
