$(document).ready(function(){ 
  ...
  $("#btnshow").click(function(){ 
		page='unitar_accdisplay.php?sektor='+$("select#sektor_idsektor").val()+'&duedate='+$("input#duedate").val()+'&duedate1='+$("input#duedate1").val()+'&dsp='+$("select#dsp").val();  
  ...
  dataString = 'sektor='+vsektor+'&duedate='+vduedate+'&duedate1='+vduedate1+'&dsp='+vdsp;
