$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="costcenter_form.php?id="+$("input#idcostcenter").val(); 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="costcenter_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
   
		page3="costcenter_display.php?id="+$("input#idcostcenter").val(); 
	...
	$("#btnlist").click(function(){ 
		window.location='costcenter.php'; 
	}); 
	 
		$("#btncetak").click(function(){ 
		window.open("costcenter_pdf.php?id="+$("input#idcostcenter").val(), "_blank");
		}); 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("costcenter_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idcostcenter"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "costcentername"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data costcenter 
	loadData(); 
 ...
 $("form#costcenter_detail").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
