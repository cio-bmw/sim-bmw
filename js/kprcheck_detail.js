$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="kprcheck_form.php?id="+$("input#idkprcheck").val(); 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="kprcheck_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
   
		page3="kprcheck_display.php?id="+$("input#idkprcheck").val(); 
	...
	$("#btnlist").click(function(){ 
		window.location='kprcheck.php'; 
	}); 
	 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("kprcheck_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
	...
	//menampilkan list data kprcheck 
	loadData(); 
