$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
    ...
    else if ($(this).val() == "ugdothers_desc"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "ugdothers_price"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "ugdothers_qty"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "ugdhdrs_idugdhdrs"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idugdothers"){ 
      dataString = 'idugdothers='+ cari;  
   } 
   else if (combo == "txn_date"){ 
      dataString = 'txn_date='+ cari; 
    } 
   else if (combo == "ugdothers_desc"){ 
      dataString = 'ugdothers_desc='+ cari; 
    } 
   else if (combo == "ugdothers_price"){ 
      dataString = 'ugdothers_price='+ cari; 
    } 
   else if (combo == "ugdothers_qty"){ 
      dataString = 'ugdothers_qty='+ cari; 
    } 
   else if (combo == "ugdhdrs_idugdhdrs"){ 
      dataString = 'ugdhdrs_idugdhdrs='+ cari; 
    } 
 
   $.ajax({ 
     url: "ugdothers_display.php", 
     type: "GET", 
     data: dataString, 
