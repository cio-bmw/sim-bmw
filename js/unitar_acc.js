$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idunitar"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "createdate"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "duedate"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    ...
    else if ($(this).val() == "custpayhdr_idcustpayhdr"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idunitar"){ 
      dataString = 'idunitar='+ cari;  
   } 
   else if (combo == "createdate"){ 
      dataString = 'createdate='+ cari; 
    } 
   else if (combo == "duedate"){ 
      dataString = 'duedate='+ cari; 
    } 
   else if (combo == "paydate"){ 
      dataString = 'paydate='+ cari; 
    } 
   else if (combo == "doknumb"){ 
      dataString = 'doknumb='+ cari; 
    } 
   else if (combo == "value"){ 
