$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		...
		page="tipe_materialbudget_form.php?id="+$('input#idtipe').val(); 
		$("#divPageEntry").load(page); 
		$("#divPageEntry").show(); 

		page1="tipe_materialbudget_dspproduct.php?id="+$('input#idtipe').val(); 
		$("#divLOV").load(page1); 
		$("#divLOV").show(); 


		page2="tipe_materialbudget_display.php?id="+$('input#idtipe').val(); 
