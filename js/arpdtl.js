$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page="arpdtl_form.php"; 
		$("#divPageEntry").load(page); 
		$("#divPageEntry").show(); 
	
		page1="arpdtl_display.php"; 
		$("#divPageData").load(page1); 
		$("#divPageData").show(); 
	
		page2="arphdr_lovslssektor.php?arphdr="+$("input#idarphdr").val()+"&idsektor="+$("input#sektor_idsektor").val(); 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
   ...
   $("#btnlist").click(function(){ 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idarpdtl"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "pvalue"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "arphdr_idarphdr"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
