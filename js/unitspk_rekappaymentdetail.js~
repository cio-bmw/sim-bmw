$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
   ...
   $("#btnlist").click(function(){ 
		window.location='unitspk_rekappayment.php'; 
	}); 
   ...
   window.open("spkpaymentdtl_rekappdf.php?id="+$("input#idunitspk").val()+"&unit="+$("input#unit_idunit").val()+"&spk="+$("input#spkcat_idspkcat").val(),"_blank"); 
	}); 
