$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="bank_form.php?id="+$("input#idbank").val(); 
		...
		page3="bank_display.php?id="+$("input#idbank").val(); 
	...
	$("#btnlist").click(function(){ 
		...
		window.open("bank_pdf.php?id="+$("input#idbank").val(), "_blank");
		}); 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("bank_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
    ...
    else if ($(this).val() == "bankname"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "rekno"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "atasnama"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data bank 
	loadData(); 
	 
  // fungsi untuk me-load tampilan list data bank, data yang ditampilkan disesuaikan 
 ...
 $("form#bank_detail").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
