$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="journaldtl_form.php"; 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="journaldtl_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
   
		page3="journaldtl_display.php"; 
	...
	$("#btnlist").click(function(){ 
		window.location='journaldtl.php'; 
	}); 
	 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("journaldtl_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idjournaldtl"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "Dvalue"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "Kvalue"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "journalhdr_idjournalhdr"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "acc_idacc"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data journaldtl 
	loadData(); 
	 
  // fungsi untuk me-load tampilan list data journaldtl, data yang ditampilkan disesuaikan 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idjournaldtl"){ 
      dataString = 'idjournaldtl='+ cari;  
   } 
   ...
   else if (combo == "journalhdr_idjournalhdr"){ 
      dataString = 'journalhdr_idjournalhdr='+ cari; 
    } 
 ...
 $("form#journaldtl").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
