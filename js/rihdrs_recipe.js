$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idrecipe"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "recipe_date"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "recipe_name"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idrecipe"){ 
      dataString = 'idrecipe='+ cari;  
   } 
   else if (combo == "recipe_date"){ 
      dataString = 'recipe_date='+ cari; 
    } 
   else if (combo == "recipe_name"){ 
      dataString = 'recipe_name='+ cari; 
    } 
