$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="task_form.php?id="+$("input#idtask").val(); 
		...
		page3="task_display.php?id="+$("input#idtask").val(); 
...
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("task_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
 ...
 $("form#task_detail").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
