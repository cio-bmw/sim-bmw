$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="group_member_form.php?id="+$("input#idgroup_member").val(); 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="group_member_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
   
		page3="group_member_display.php?id="+$("input#idgroup_member").val(); 
	...
	$("#btnlist").click(function(){ 
		window.location='group_member.php'; 
	}); 
	 
		$("#btncetak").click(function(){ 
		window.open("group_member_pdf.php?id="+$("input#idgroup_member").val(), "_blank");
		}); 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("group_member_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
	...
	//menampilkan list data group_member 
	loadData(); 
 ...
 $("form#group_member_detail").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
