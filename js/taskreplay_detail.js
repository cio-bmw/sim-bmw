$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="taskreplay_form.php?id="+$("input#idtaskreplay").val(); 
		...
		page3="taskreplay_display.php?id="+$("input#idtaskreplay").val(); 
	...
	$("#btnlist").click(function(){ 
		window.location='taskreplay.php'; 
	}); 
	 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("taskreplay_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
 ...
 $("form#taskreplay_detail").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
