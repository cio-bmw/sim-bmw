$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
    ...
    else if ($(this).val() == "costcenter_idcostcenter"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data cashouthdr 
	loadData(); 
