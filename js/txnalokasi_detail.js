$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="txnalokasi_form.php"; 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="txnalokasi_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
	...
	$("#btnlist").click(function(){ 
		window.location='txnalokasi.php'; 
	}); 
	 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("txnalokasi_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idtxnalokasi"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "alokasiname"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data txnalokasi 
	loadData(); 
 ...
 $("form#txnalokasi").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
