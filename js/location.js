$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idlocation"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "locationname"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idlocation"){ 
      dataString = 'idlocation='+ cari;  
   } 
   else if (combo == "locationname"){ 
      dataString = 'locationname='+ cari; 
    } 
 
   $.ajax({ 
     url: "location_display.php", 
     type: "GET", 
     data: dataString, 
