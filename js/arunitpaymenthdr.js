$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page="arunitpaymenthdr_form.php?idsektor="+$("select#sektor_idsektor").val(); 
		$("#divPageEntry").load(page); 
		$("#divPageEntry").show(); 
		
		page="arunitpaymenthdr_unitlov.php?idsektor="+$("select#sektor_idsektor").val(); 
		$("#divLOV").load(page); 
		$("#divLOV").show(); 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idarunithdr"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "paydate"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "payby"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "rcvby"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data arunitpaymenthdr 
	loadData(); 
	 
  // fungsi untuk me-load tampilan list data arunitpaymenthdr, data yang ditampilkan disesuaikan 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idarunithdr"){ 
      dataString = 'idarunithdr='+ cari;  
   } 
   else if (combo == "paydate"){ 
      dataString = 'paydate='+ cari; 
    } 
   else if (combo == "payby"){ 
      dataString = 'payby='+ cari; 
    } 
   else if (combo == "rcvby"){ 
      dataString = 'rcvby='+ cari; 
    } 
   ...
   $.ajax({ 
     url: "arunitpaymenthdr_display.php", 
     type: "GET", 
     data: dataString, 
