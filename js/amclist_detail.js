$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="amclist_form.php"; 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="amclist_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
