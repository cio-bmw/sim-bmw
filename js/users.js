$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "user_code"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "user_passwd"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "user_role"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "user_code"){ 
      dataString = 'user_code='+ cari;  
   } 
   else if (combo == "user_passwd"){ 
      dataString = 'user_passwd='+ cari; 
    } 
   else if (combo == "user_role"){ 
      dataString = 'user_role='+ cari; 
    } 
 
   $.ajax({ 
     url: "users_display.php", 
     type: "GET", 
     data: dataString, 
