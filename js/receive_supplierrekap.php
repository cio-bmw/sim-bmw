...
<script type="text/javascript" src="js/receive_supplierrekap.js"></script> 
...
<div id="divSearch"> 
  ...
  <td class="judul">
  Start : <input type="text" size=8 name="startdate" id="startdate" value="<? echo $startdate; ?>" /> 
  End : <input type="text" size=8 name="enddate" id="enddate" value="<? echo $enddate; ?>" /> 
