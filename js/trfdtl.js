$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
    ...
    else if ($(this).val() == "trfhdr_idtrfhdr"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idtrfdtl"){ 
      dataString = 'idtrfdtl='+ cari;  
   } 
   else if (combo == "qty"){ 
      dataString = 'qty='+ cari; 
    } 
   else if (combo == "trfhdr_idtrfhdr"){ 
      dataString = 'trfhdr_idtrfhdr='+ cari; 
    } 
