$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page="arunitpaymentdtl_form.php"; 
    ...
    else if ($(this).val() == "arunitpaymenthdr_idarunithdr"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data arunitpaymentdtl 
	loadData(); 
	 
  // fungsi untuk me-load tampilan list data arunitpaymentdtl, data yang ditampilkan disesuaikan 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idarunitdtl"){ 
      dataString = 'idarunitdtl='+ cari;  
   } 
   else if (combo == "value"){ 
      dataString = 'value='+ cari; 
    } 
   else if (combo == "unitmstpayment_idpayment"){ 
      dataString = 'unitmstpayment_idpayment='+ cari; 
    } 
   else if (combo == "arunitpaymenthdr_idarunithdr"){ 
      dataString = 'arunitpaymenthdr_idarunithdr='+ cari; 
    } 
 
   $.ajax({ 
     url: "arunitpaymentdtl_display.php", 
     type: "GET", 
     data: dataString, 
