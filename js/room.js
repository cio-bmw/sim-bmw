$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
    ...
    else if ($(this).val() == "roomname"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "bangsal_idbangsal"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idroom"){ 
      dataString = 'idroom='+ cari;  
   } 
   else if (combo == "roomname"){ 
      dataString = 'roomname='+ cari; 
    } 
   else if (combo == "bangsal_idbangsal"){ 
      dataString = 'bangsal_idbangsal='+ cari; 
    } 
   else if (combo == "kelas"){ 
      dataString = 'kelas='+ cari; 
    } 
   else if (combo == "tarif"){ 
