$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
		page1="whcashout_form.php"; 
		$("#divPageEntry").load(page1); 
		$("#divPageEntry").show(); 
   
		page2="whcashout_lov.php"; 
		$("#divLOV").load(page2); 
		$("#divLOV").show(); 
	...
	$("#btnlist").click(function(){ 
		window.location='whcashout.php'; 
	}); 
	 
$("#btnconfirm").click(function(){  
	if (confirm("Apakah benar akan Konfirmasi Data Transaksi Ini?")){  
	    window.open("whcashout_confirm.php?id="+$("input#idslshdr").val(),"_blank"); }  
	    else { 
	...
	//menampilkan list data whcashout 
	loadData(); 
 ...
 $("form#whcashout").submit(function(){  
   var cari = $("input#fieldcari").val(); 
   var combo = $("select#pilihcari").val(); 
