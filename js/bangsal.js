$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
	...
	$("select#pilihcari").change(function(){  
  	if ($(this).val() == "idbangsal"){ 
  	  $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "bangsal_name"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idbangsal"){ 
      dataString = 'idbangsal='+ cari;  
   } 
   else if (combo == "bangsal_name"){ 
      dataString = 'bangsal_name='+ cari; 
    } 
 
   $.ajax({ 
     url: "bangsal_display.php", 
     type: "GET", 
     data: dataString, 
