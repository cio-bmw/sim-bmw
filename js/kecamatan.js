$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
    ...
    else if ($(this).val() == "kecname"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "kabupaten_idkab"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idkec"){ 
      dataString = 'idkec='+ cari;  
   } 
   else if (combo == "kecname"){ 
      dataString = 'kecname='+ cari; 
    } 
   else if (combo == "kabupaten_idkab"){ 
      dataString = 'kabupaten_idkab='+ cari; 
    } 
 
   $.ajax({ 
     url: "kecamatan_display.php", 
     type: "GET", 
     data: dataString, 
