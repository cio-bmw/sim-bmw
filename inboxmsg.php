...
<div id="divSearch"> 
  ...
  <td>inboxmsg <select id="pilihcari">  
      <option value="idinboxmsg">idinboxmsg</option> 
      <option value="status">status</option> 
      <option value="msg">msg</option> 
      <option value="inboxdate">inboxdate</option> 
      <option value="emp_idempfrom">emp_idempfrom</option> 
      <option value="emp_idempto">emp_idempto</option> 
