...
function pagination(page){ 
  ...
  $.ajax({ 
    url:"spkpaymentdtl_displaydtl.php", 
    data: dataString, 
		type:"GET", 
...
function loadData(){ 
  ...
  $.ajax({ 
    url: "spkpaymentdtl_displaydtl.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
<td class="right"><? echo nf($row['payvalue']);?></td>
           <td width="100px"> 
       <a href="spkpaymentdtl_form.php?action=update&id=<? echo $row['idspkpaymentdtl'];?>" class="edit"> <input type="button" class="button" value="Edit"></a>   
       | <a href="spkpaymentdtl_process.php?action=delete&id=<? echo $row['idspkpaymentdtl'];?>" class="delete"><input type="button" class="button" value="Delete"></a> 
         </td> 
