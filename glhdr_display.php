...
if (isset($_GET['idglhdr']) and !empty($_GET['idglhdr'])){ 
 $idglhdr = $_GET['idglhdr']; 
  $sql = "select * from glhdr where idglhdr like '%$idglhdr%' order by idglhdr desc"; 
} 
else if (isset($_GET['gl_date']) and !empty($_GET['gl_date'])){ 
 $gl_date = $_GET['gl_date']; 
  $sql = "select * from glhdr where gl_date like '%$gl_date%' order by gl_date"; 
} 
else if (isset($_GET['gl_desc']) and !empty($_GET['gl_desc'])){ 
 $gl_desc = $_GET['gl_desc']; 
  $sql = "select * from glhdr where gl_desc like '%$gl_desc%' order by gl_desc"; 
} 
else if (isset($_GET['gl_refno']) and !empty($_GET['gl_refno'])){ 
 $gl_refno = $_GET['gl_refno']; 
  $sql = "select * from glhdr where gl_refno like '%$gl_refno%' order by gl_refno"; 
} 
else{ 
  $sql = "select * from glhdr"; 
} 
