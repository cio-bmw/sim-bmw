...
<script type="text/javascript" src="js/unitkpr.js"></script> 
...
<div id="divSearch"> 
  ...
  <td> 
   <form id="unitkpr" method="POST" action="" name="unitkpr">  
  Cari Data : <select id="pilihcari">  
      <option value="idunitkpr">idunitkpr</option> 
      <option value="check_date">check_date</option> 
