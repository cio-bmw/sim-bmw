...
<script type="text/javascript" src="js/unithistory.js"></script> 
...
<div id="divSearch"> 
  ...
  <td> 
   <form id="unithistory" method="POST" action="" name="unithistory">  
  Cari Data : <select id="pilihcari">  
      <option value="idunithistory">idunithistory</option> 
      <option value="namauser">namauser</option> 
      <option value="tglmundur">tglmundur</option> 
