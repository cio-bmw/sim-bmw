...
<div id="divSearch"> 
  ...
  <td> 
   <form id="inbox" method="POST" action="" name="inbox">  
  Cari Data : <select id="pilihcari">  
      <option value="UpdatedInDB">UpdatedInDB</option> 
      <option value="ReceivingDateTime">ReceivingDateTime</option> 
      <option value="Text">Text</option> 
      <option value="SenderNumber">SenderNumber</option> 
      ...
      <option value="RecipientID">RecipientID</option> 
