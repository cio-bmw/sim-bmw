...
$yx = $pdf->getY()+40;
$pdf->SetY($yx);
$pdf->text($x,$yx,'Daftar sektorcosthdr');
...
$pdf->SetY($yx);
//buat header tabel//
 $pdf->cell(30,$rh,idsektorcosthdr,1,0,'C',0); 
...
$yx =$pdf->getY()+$rh; 
$pdf->SetY($yx);
$sql = " select idsektorcosthdr,txndate,txndesc,sektor_idsektor from sektorcosthdr"; 
$result = mysql_query($sql); 
$i=1;  
$no=1;  
$max =21;  
 while($row = mysql_fetch_array($result)) { 
 $pdf->cell(30,$rh,$row['idsektorcosthdr'],1,0,'L',0); 
