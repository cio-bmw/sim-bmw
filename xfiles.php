...
<div id="divSearch"> 
  ...
  <td>xfiles <select id="pilihcari">  
      <option value="idxfiles">idxfiles</option> 
      <option value="xfilesname">xfilesname</option> 
      <option value="xfilesdesc">xfilesdesc</option> 
      <option value="xfilesdate">xfilesdate</option> 
