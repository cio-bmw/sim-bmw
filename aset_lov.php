...
function loadData(){ 
  ...
  $.ajax({ 
    url: "aset_lov.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
$(function(){  
 ...
 function sendaset(n1,n2) 
 {
     window.opener.document.getElementById('aset_idaset').value=n1;
     window.opener.document.getElementById('aset').value=n2;
     window.close();
 } 
</script> 
...
$fieldcari = $_POST['fieldcari']; 
  ...
  $sql = "select * from aset where idaset like '%".$fieldcari."%'";  
...
<td><input class="button" type=button value="Pilih" onClick="sendaset('<? echo $row['idaset'];?>','<? echo $row['aset'];?>  ' )"></td>
  		<?} //end while ?> 
