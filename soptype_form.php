...
$(function(){ 
 ...
 $("input").not($(":submit")).keypress(function (evt) {  
  ...
  $("form#soptype_form").submit(function(){ 
    if (confirm("Apakah benar akan menyimpan data soptype ini?")){ 
    		$.ajax({ 
        	url: "soptype_process.php", 
        	...
        	success:function(response){ 
              ...
              loadData(); //reload list data 
          		$("#divPageEntry").load("soptype_form.php");   
              $("#divPageEntry").hide(); 
            } 
          else if(response.status == 1) { 
          	  alert("Data Baru berhasil disimpan!"); 
              loadData(); //reload list data 
         //   window.location="soptype_detail.php?id="+$("input#idslshdr").val(); 
                    		} 
          	else 
          	{ 
...
<form method="post" name="soptype_form" action="" id="soptype_form">  
<p class="judul">Form Memasukkan / Edit Data soptype</p>  
<table> 
...
<?php } else {?> 
<tr><td class="right">idsoptype</td><td><input type="text" id="idsoptype" name="idsoptype" size="10" value="<? echo $idsoptype;?>" /></td> 
</tr> 
<?php }?> 
<tr> 
<td class="right">soptype</td> 
<td><input type="text" id="soptype" name="soptype" size="30" maxlength="45" value="<? echo $soptype;?>" /></td> 
</tr> 
<tr> 
