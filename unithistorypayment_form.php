...
$(function(){ 
  $("input#unithistorypayment").focus();  
 ...
 $("input").not($(":submit")).keypress(function (evt) {  
  ...
  $("form#unithistorypayment_form").submit(function(){ 
    if (confirm("Apakah benar akan menyimpan data unithistorypayment ini?")){ 
    		$.ajax({ 
        	url: "unithistorypayment_process.php", 
        	...
        	success:function(response){ 
              ...
              loadData(); //reload list data 
          		$("#divPageEntry").load("unithistorypayment_form.php");   
              $("#divPageEntry").hide(); 
            } 
          else if(response.status == 1) { 
          	  alert("Data Baru berhasil disimpan!"); 
              loadData(); //reload list data 
         //   window.location="unithistorypayment_detail.php?id="+$("input#idslshdr").val(); 
                    		} 
          	else 
          	{ 
 ...
 $("#btnclose").click(function(){  
      ...
      $("#divLOV").hide();  
		...
		page3="unithistorypayment_display.php";  
...
<form method="post" name="unithistorypayment_form" action="" id="unithistorypayment_form">  
<p class="judul">Form Memasukkan / Edit Data unithistorypayment</p>  
<table> 
...
<?php } else {?> 
<tr><td class="right">idunithistorypayment</td><td><input type="text" id="idunithistorypayment" name="idunithistorypayment" size="10" value="<? echo $idunithistorypayment;?>" /></td> 
</tr> 
<?php }?> 
<tr> 
