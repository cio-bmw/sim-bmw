...
<script type="text/javascript" src="js/prospek.js"></script> 
...
<div id="divSearch"> 
  ...
  <td> 
   <form id="prospek" method="POST" action="" name="prospek">  
  Cari Data : <select id="pilihcari">  
      <option value="idprospek">idprospek</option> 
      <option value="prospek">prospek</option> 
      <option value="phone">phone</option> 
      <option value="alamat">alamat</option> 
      <option value="catatan">catatan</option> 
      <option value="marketing_idmarketing">marketing_idmarketing</option> 
