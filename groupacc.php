...
<script type="text/javascript" src="js/groupacc.js"></script> 
</head> 
<body> 
...
<div id="divSearch"> 
  ...
  <td> 
   <form id="groupacc" method="POST" action="" name="groupacc">  
  Cari Data : <select id="pilihcari">  
      <option value="idgroupacc">id</option> 
      <option value="groupname">Group Account</option> 
