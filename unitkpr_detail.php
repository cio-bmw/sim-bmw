...
<script type="text/javascript" src="js/unitkpr_detail.js"></script> 
</head> 
<body> 
<? include_once "header.php"; ?>  
<div id="divSearch"> 
 <form id="unitkpr_detail" method="POST" action="" name="unitkpr_detail"> 
...
<p class="judul">Data Detail unitkpr</p>
 <table> 
...
<td><input type="text" id="check_date" name="check_date" size="30" maxlength="25" value="<? echo $check_date;?>" readonly /></td> 
</tr> 
<tr> 
