...
<script type="text/javascript" src="js/accsetting.js"></script> 
...
<div id="divSearch"> 
  ...
  <td> 
   <form id="accsetting" method="POST" action="" name="accsetting">  
  Cari Data : <select id="pilihcari">  
      <option value="idaccsetting">idaccsetting</option> 
      <option value="app">app</option> 
      <option value="dacc_idacc">dacc_idacc</option> 
      <option value="kacc_idacc">kacc_idacc</option> 
