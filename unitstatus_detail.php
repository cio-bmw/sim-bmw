...
<div id="divSearch"> 
  <form id="formSearch"> 
  <table  class="header" ><tr><td class="judul">Data Detail unitstatus &nbsp; 
...
<td><input type="text" id="unitstatusname" name="unitstatusname" size="30" maxlength="25" value="<? echo $unitstatusname;?>" readonly /></td> 
</tr> 
</table> 
</div>  
<br />  
