$(document).ready(function(){ 
  ...
  $("#btntambah").click(function(){ 
    ...
    else if ($(this).val() == "hargasat"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
    else if ($(this).val() == "txntotal"){ 
      $("td#kolompilih").show(); 
      $("input#fieldcari").show(); 
      $("input#fieldcari").focus(); 
    } 
	...
	//menampilkan list data sektorrab 
	loadData(); 
  ...
  function loadData(){ 
	  ...
	  if (combo == "idsektorrab"){ 
      dataString = 'idsektorrab='+ cari;  
   } 
   else if (combo == "volume"){ 
      dataString = 'volume='+ cari; 
    } 
   else if (combo == "hargasat"){ 
      dataString = 'hargasat='+ cari; 
    } 
   else if (combo == "txntotal"){ 
      dataString = 'txntotal='+ cari; 
    } 
