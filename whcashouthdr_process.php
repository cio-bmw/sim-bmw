<? 
 ...
 mysql_query(" insert into whcashouthdr (idcashouthdr,txndate,txndesc)  values  ('$idcashouthdr','$txndate','$txndesc')")  or die("Data gagal Di Tambahkan!");  
	...
	{ 
$sql = " update whcashouthdr set idcashouthdr='$idcashouthdr',txndate='$txndate',txndesc='$txndesc' where idcashouthdr = $idcashouthdr";  
	...
	{ 
		$id = $_GET['id']; 
		$test = mysql_query("delete from whcashouthdr where idcashouthdr ='$id'"); 
