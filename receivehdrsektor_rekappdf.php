...
$sql = "select distinct supplier_idsupp from receivehdrsektor where rcv_date between '$startdate' and '$enddate' order by supplier_idsupp"; 
...
$pdf->cell(25,$rh,$idsupp,1,0,'L',0); 
$pdf->cell(75,$rh,$suppname,1,0,'L',0); 
