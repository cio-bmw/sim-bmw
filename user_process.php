<? 
 ...
 mysql_query(" insert into user (username,passwd,usr_lvl)  values  ('$username','$passwd','$usr_lvl')")  or die("Data gagal Di Tambahkan!");  
	...
	{ 
$sql = " update user set username='$username',passwd='$passwd',usr_lvl='$usr_lvl' where username = $username";  
	...
	{ 
		$id = $_GET['id']; 
		$test = mysql_query("delete from user where username ='$id'"); 
