...
$sql = "select distinct supplier_idsupp from receivehdr where rcv_date between '$startdate' and '$enddate' and supplier_idsupp like '%$isupplier%' order by supplier_idsupp"; 
