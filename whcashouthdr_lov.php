...
function loadData(){ 
  ...
  $.ajax({ 
    url: "whcashouthdr_lov.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
$fieldcari = $_POST['fieldcari']; 
  ...
  $sql = "select * from whcashouthdr where idcashouthdr like '%".$fieldcari."%'";  
