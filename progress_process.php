<? 
 ...
 $progressname=$_POST['progressname']; 
 ...
 mysql_query(" insert into progress (idprogress,progressname)  values  ('$idprogress','$progressname')")  or die("Data gagal Di Tambahkan!");  
	...
	{ 
$sql = " update progress set idprogress='$idprogress',progressname='$progressname' where idprogress = $idprogress";  
	...
	{ 
		$id = $_GET['id']; 
		$test = mysql_query("delete from progress where idprogress ='$id'"); 
