...
<script type="text/javascript" src="js/prospekflow.js"></script> 
...
<div id="divSearch"> 
  ...
  <td> 
   <form id="prospekflow" method="POST" action="" name="prospekflow">  
  Cari Data : <select id="pilihcari">  
      <option value="idprospekflow">idprospekflow</option> 
      <option value="prospekflow">prospekflow</option> 
      <option value="dateflow">dateflow</option> 
      <option value="prospek_idprospek">prospek_idprospek</option> 
