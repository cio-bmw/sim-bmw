...
<div id="divSearch">
    <table class="header">
        <tr>
            <td>
                <form id="activity" method="POST" action="" name="activity">
                    Cari Data : <select id="pilihcari">
                        <option value="idactivity">idactivity</option>
                        <option value="activity">activity</option>
                        <option value="soptype_idsoptype">soptype_idsoptype</option>
                        <option value="unitact_idunitact">unitact_idunitact</option>
