...
function loadData(){ 
  ...
  $.ajax({ 
    url: "slsdtlsektor_displaymini.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: param, 
		success:function(data) 
		{ 
	...
	$("a.delete").click(function(){ 
		...
		{ 
            ...
            alert("Data slsdtlsektor berhasil di hapus!"); 
						...
						alert("data slsdtlsektor gagal di hapus!"); 
					} 
				} 
			}); 
		} 
...
$result = $obj->result; 
?> 
	 <p class="judul">Daftar Barang Yang Di Keluarkan</p>
  <table width="495px" id="slsdtlsektor"> 
  <tr> 
 <th>No</th>
 <th>Kode</th>
 <th>Nama Barang</th>
