...
$sql = "select distinct sektor_idsektor from receivehdrsektor where rcv_date between '$startdate' and '$enddate' and supplier_idsupp like '%$isupplier%' order by supplier_idsupp"; 
...
<p class="judul"> Rekap Nilai Penerimaan Barang Per Sektor</p>
<tr> 
<th>Kode</th>
<th>Nama Supplier</th>
<th>Total Tagihan</th>
