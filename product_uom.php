...
<script type="text/javascript" src="js/product_uom.js"></script> 
</head> 
<body> 
<table class="white">
<tr><td class="white"><img src="images/logo.png"></td></tr>
<tr><td class="judul">Data product_uom</td></tr>
</table>
<div id="divSearch"> 
  <form id="formSearch"> 
  <table><tr> 
  <td>Cari Berdasarkan</td><td><select id="pilihcari">  
      <option value="qty_uom">qty_uom</option> 
      <option value="harga_uom">harga_uom</option> 
      <option value="uom_iduom">uom_iduom</option> 
