...
$("#btncetak").click(function(){ 
     ...
     window.open('receivehdrsektor_rekapproductpdf.php?idsupp='+vsupp+'&startdate='+vstart+'&enddate='+vend,'_blank');
...
$sql="SELECT product_idproduct,sum(qty) qty,sum(receive_price * qty) jumlah FROM receivedtlsektor a, receivehdrsektor b  
