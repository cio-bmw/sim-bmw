<? 
 ...
 mysql_query(" insert into product_expstok (exp_date,stok,product_idproduct,rcv_date)  values  ('$exp_date','$stok','$product_idproduct','$rcv_date')")  or die("Data gagal Di Tambahkan!");  
	...
	{ 
$sql = " update product_expstok set exp_date='$exp_date',stok='$stok',product_idproduct='$product_idproduct',rcv_date='$rcv_date' where exp_date = $exp_date";  
	...
	{ 
		$id = $_GET['id']; 
		$test = mysql_query("delete from product_expstok where exp_date ='$id'"); 
