...
<tr><td class="judul">Data user</td></tr>
</table>
<div id="divSearch"> 
  <form id="formSearch"> 
  <table><tr> 
  <td>Cari Berdasarkan</td><td><select id="pilihcari">  
      ...
      <option value="usr_lvl">usr_lvl</option> 
 ...
 <input class="button" class="button" class="button" type="button" value="Tambah" id="btntambah">
   <input class="button" class="button" class="button" type="button" value="Kembali Ke Menu" id="btnexit">
  </td> </tr></table>
  </form><br /> 
</div> 
