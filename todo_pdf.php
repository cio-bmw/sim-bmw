...
$pdf->cell(30,$rh,'Daftar todo',0,0,'C',0);
...
$pdf->SetY($yx);
//buat header tabel//
 $pdf->cell(30,$rh,idtodo,1,0,'C',0); 
$pdf->cell(30,$rh,todo,1,0,'C',0); 
$pdf->cell(30,$rh,startdate,1,0,'C',0); 
$pdf->cell(30,$rh,enddate,1,0,'C',0); 
$pdf->cell(30,$rh,todostatus,1,0,'C',0); 
...
$max =21;  
 ...
 $pdf->cell(30,$rh,$row['idtodo'],1,0,'L',0); 
$pdf->cell(30,$rh,$row['todo'],1,0,'L',0); 
$pdf->cell(30,$rh,$row['startdate'],1,0,'L',0); 
$pdf->cell(30,$rh,$row['enddate'],1,0,'L',0); 
$pdf->cell(30,$rh,$row['todostatus'],1,0,'L',0); 
