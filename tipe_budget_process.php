<? 
 ...
 mysql_query(" insert into tipe_budget (idbudget,qty,tipe_idtipe,product_idproduct)  values  ('$idbudget','$qty','$tipe_idtipe','$product_idproduct')")  or die("Data gagal Di Tambahkan!");  
	...
	{ 
$sql = " update tipe_budget set idbudget='$idbudget',qty='$qty',tipe_idtipe='$tipe_idtipe',product_idproduct='$product_idproduct' where idbudget = $idbudget";  
	...
	{ 
		$id = $_GET['id']; 
		$test = mysql_query("delete from tipe_budget where idbudget ='$id'"); 
