...
function loadData(){ 
  ...
  $.ajax({ 
    url: "returndtl_dspproduct.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
$("#btncarilov").click(function(){ 
 	...
 	page="returndtl_dspproduct.php?id="+$("input#idslshdr").val()+"&fieldcari="+$("input#fieldcari").val();
		$("#divLOV").load(page); 
		$("#divLOV").show(); 
		$("#btnhide").show(); 
		return false; 
