...
<div id="divSearch"> 
  ...
  <td>publicchat <select id="pilihcari">  
      <option value="idpublicchat">idpublicchat</option> 
      <option value="chatdate">chatdate</option> 
      <option value="chatmsg">chatmsg</option> 
      <option value="chatimg">chatimg</option> 
