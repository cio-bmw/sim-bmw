...
printer_draw_text($printer,DeliveryDateTime,$x+10,$y); 
...
printer_draw_text($printer,SequencePosition,$x+10,$y); 
printer_draw_text($printer,Status,$x+10,$y); 
printer_draw_text($printer,StatusError,$x+10,$y); 
printer_draw_text($printer,TPMR,$x+10,$y); 
...
printer_draw_text($printer,$row['DeliveryDateTime'],$x+10,$y); 
...
printer_draw_text($printer,$row['SequencePosition'],$x+10,$y); 
printer_draw_text($printer,$row['Status'],$x+10,$y); 
printer_draw_text($printer,$row['StatusError'],$x+10,$y); 
printer_draw_text($printer,$row['TPMR'],$x+10,$y); 
