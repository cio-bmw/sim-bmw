<? 
 ...
 $slshdr_idslshdr=$_POST['slshdr_idslshdr']; 
 ...
 mysql_query(" insert into slsdtl (idslsdtl,cost_price,qty,dtl_discount,sales_price,dtl_percent,product_idproduct,slshdr_idslshdr)  values  ('$idslsdtl','$cost_price','$qty','$dtl_discount','$sales_price','$dtl_percent','$product_idproduct','$slshdr_idslshdr')")  or die("Data gagal Di Tambahkan!");  
	...
	{ 
$sql = " update slsdtl set idslsdtl='$idslsdtl',cost_price='$cost_price',qty='$qty',dtl_discount='$dtl_discount',sales_price='$sales_price',dtl_percent='$dtl_percent',product_idproduct='$product_idproduct',slshdr_idslshdr='$slshdr_idslshdr' where idslsdtl = $idslsdtl";  
	...
	{ 
		$id = $_GET['id']; 
		$test = mysql_query("delete from slsdtl where idslsdtl ='$id'"); 
