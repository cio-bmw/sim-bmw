<? 
  ...
  $action=$_POST['action']; 
 $idstockloc=$_POST['idstockloc']; 
 $stocklocname=$_POST['stocklocname']; 
 ...
 mysql_query(" insert into stockloc (idstockloc,stocklocname)  values  ('$idstockloc','$stocklocname')")  or die("Data gagal Di Tambahkan!");  
	...
	{ 
$sql = " update stockloc set idstockloc='$idstockloc',stocklocname='$stocklocname' where idstockloc = $idstockloc";  
	...
	{ 
		$id = $_GET['id']; 
		$test = mysql_query("delete from stockloc where idstockloc ='$id'"); 
