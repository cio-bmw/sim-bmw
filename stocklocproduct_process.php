<? 
 ...
 $stockloc_idstockloc=$_POST['stockloc_idstockloc']; 
 ...
 mysql_query(" insert into stocklocproduct (qtystock,product_idproduct,stockloc_idstockloc)  values  ('$qtystock','$product_idproduct','$stockloc_idstockloc')")  or die("Data gagal Di Tambahkan!");  
	...
	{ 
$sql = " update stocklocproduct set qtystock='$qtystock',product_idproduct='$product_idproduct',stockloc_idstockloc='$stockloc_idstockloc' where qtystock = $qtystock";  
	...
	{ 
		$id = $_GET['id']; 
		$test = mysql_query("delete from stocklocproduct where qtystock ='$id'"); 
