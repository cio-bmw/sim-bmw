...
function loadData(){ 
  ...
  $.ajax({ 
    url: "whcashout_lov.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
$(function(){  
 ...
 function sendwhcashout(n1,n2) 
 {
     document.getElementById('whcashout_idcashout').value=n1;
     document.getElementById('whcashout').value=n2;
 } 
</script> 
...
$fieldcari = $_POST['fieldcari']; 
  ...
  $sql = "select * from whcashout where idwhcashout like '%".$fieldcari."%'";  
...
?> 
	...
	<body> 
	<form method="post" name="whcashout_lov" action="" id="whcashout_lov">  
	<table>  
	<tr><td colspan=5 > 
...
<td><input class="button" type=button value="Pilih" onClick="sendwhcashout('<? echo $row['idcashout'];?>','<? echo $row['whcashout'];?>  ' )"></td>
  		<?} //end while ?> 
