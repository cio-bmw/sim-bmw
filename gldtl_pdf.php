...
$pdf->cell(30,$rh,'Daftar gldtl',0,0,'C',0);
...
$pdf->SetY($yx);
//buat header tabel//
 $pdf->cell(30,$rh,idgldtl,1,0,'C',0); 
$pdf->cell(30,$rh,glhdr_idglhdr,1,0,'C',0); 
$pdf->cell(30,$rh,Dvalue,1,0,'C',0); 
$pdf->cell(30,$rh,Kvalue,1,0,'C',0); 
$pdf->cell(30,$rh,acc_idacc,1,0,'C',0); 
 
 $yr= $pdf->getY()+$rh; $pdf->setY($yr);$pdf->SetX($x); 
$sql = " select * from gldtl"; 
$result = mysql_query($sql); 
$i=1;  
$no=1;  
$max =21;  
 while($row = mysql_fetch_array($result)) { 
 $pdf->cell(30,$rh,$row['idgldtl'],1,0,'L',0); 
$pdf->cell(30,$rh,$row['glhdr_idglhdr'],1,0,'L',0); 
