...
<script type="text/javascript" src="js/soptype.js"></script> 
...
<div id="divSearch"> 
  ...
  <td> 
   <form id="soptype" method="POST" action="" name="soptype">  
  Cari Data : <select id="pilihcari">  
      <option value="idsoptype">idsoptype</option> 
      <option value="soptype">soptype</option> 
