...
function loadData(){ 
  ...
  $.ajax({ 
    url: "kpr_lov.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
$(function(){  
 ...
 function sendkpr(n1,n2) 
 {
     window.opener.document.getElementById('kpr_idkpr').value=n1;
     window.opener.document.getElementById('kprname').value=n2;
     window.close();
 } 
</script> 
...
$fieldcari = $_POST['fieldcari']; 
  ...
  $sql = "select * from kpr where idkpr like '%".$fieldcari."%'";  
...
<td><input class="button" type=button value="Pilih" onClick="sendkpr('<? echo $row['idkpr'];?>','<? echo $row['kprname'];?>  ' )"></td>
  		<?} //end while ?> 
