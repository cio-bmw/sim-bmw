...
<div id="divSearch"> 
  <form id="formSearch"> 
  <table  class="header" ><tr><td class="judul">Data Detail doccat &nbsp; 
...
<td><input type="text" id="doccatname" name="doccatname" size="30" maxlength="25" value="<? echo $doccatname;?>" readonly /></td> 
</tr> 
</table> 
</div>  
<br />  
