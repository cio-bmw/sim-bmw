...
function loadData(){ 
  ...
  $.ajax({ 
    url: "whcashoutdtl_display.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
$sql = "select * from whcashoutdtl where cashouthdr_idcashouthdr='$id'"; 
...
<td class="right"><? echo nf($row['txnvalue']);?></td>
        ...
        <td><a href="whcashoutdtl_form.php?action=update&id=<? echo $row['idcashoutdtl'];?>" class="edit"> <input type="button" class="button" value="Edit"></a>   
       | <a href="whcashoutdtl_process.php?action=delete&id=<? echo $row['idcashoutdtl'];?>" class="delete"><input type="button" class="button" value="Delete"></a></td></tr> 
  		<?  
      $no++;  		
  		} //end while ?> 
