...
$(function(){  
 ...
 function senduom(n1,n2) 
 {
     document.getElementById('uom_iduom').value=n1;
     document.getElementById('uomname').value=n2;
     $('#divLOV').hide();
 } 
</script> 
...
$fieldcari = $_POST['fieldcari']; 
  ...
  $sql = "select * from uom where iduom like '%".$fieldcari."%'";  
...
<th>Aksi</th> 
       ...
       <tr> 
 <td><? echo $row['iduom'];?></td>
<td><? echo $row['uomname'];?></td>
 
<td><input class="button" type=button value="Pilih" onClick="senduom('<? echo $row['iduom'];?>','<? echo $row['uomname'];?>  ' )"></td>
  		<?} //end while ?> 
