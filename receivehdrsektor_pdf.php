...
$yx = $pdf->getY()+40;
$pdf->SetY($yx);
$pdf->text($x,$yx,'Daftar receivehdrsektor');
...
$yx =$pdf->getY()+$rh; 
$pdf->SetY($yx);
$sql = " select idreceivehdr,supplier_idsupp,sektor_idsektor,rcv_date,rcv_bon,rcv_titip,rcv_desc,due_date,paid_date,faktur,rcv_bayar,rcv_status,rcv_diskon,rcv_totprice,rcv_totdiskon,rcv_totppn from receivehdrsektor"; 
