...
function loadData(){ 
  ...
  $.ajax({ 
    url: "historypayment_lov.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
$(function(){  
  ...
  $("#btncari").click(function(){  
  		page1="historypayment_lov.php?cari="+$("input#carilov").val();  
  		$("#divLOV").load(page1);  
  		$("#divLOV").show();  
     	return false;  
  	});   
 ...
 function sendhistorypayment(n1,n2) 
 {
     document.getElementById('historypayment_idhistorypayment').value=n1;
     document.getElementById('historypayment').value=n2;
 } 
</script> 
...
$cari = $_GET['cari']; 
  ...
  $sql = "select * from historypayment where idhistorypayment like '%".$cari."%'";  
...
?> 
	...
	<p>
	<form method="post" name="historypayment_lov" action="" id="historypayment_lov">  
...
<td><input class="button" type=button value="Pilih" onClick="sendhistorypayment('<? echo $row['idhistorypayment'];?>','<? echo $row['historypayment'];?>  ' )"></td>
  		<?} //end while ?> 
