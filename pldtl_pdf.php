...
$pdf->cell(30,$rh,'Daftar pldtl',0,0,'C',0);
...
$pdf->SetY($yx);
//buat header tabel//
 $pdf->cell(30,$rh,idpldtl,1,0,'C',0); 
$pdf->cell(30,$rh,plhdr_idplhdr,1,0,'C',0); 
...
$max =21;  
 ...
 $pdf->cell(30,$rh,$row['idpldtl'],1,0,'L',0); 
$pdf->cell(30,$rh,$row['plhdr_idplhdr'],1,0,'L',0); 
