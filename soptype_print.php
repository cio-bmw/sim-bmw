...
// membuat header 
printer_draw_text($printer,idsoptype,$x+10,$y); 
printer_draw_text($printer,soptype,$x+10,$y); 
...
printer_draw_text($printer,$row['idsoptype'],$x+10,$y); 
printer_draw_text($printer,$row['soptype'],$x+10,$y); 
