...
<script type="text/javascript" src="js/pldtl_detail.js"></script> 
</head> 
<body> 
<table class="white">
...
<div id="divSearch"> 
  <form id="formSearch"> 
  <table  class="header" ><tr><td class="judul">Data Detail pldtl &nbsp; 
...
<td><input type="text" id="plhdr_idplhdr" name="plhdr_idplhdr" size="30" maxlength="25" value="<? echo $plhdr_idplhdr;?>" readonly /></td> 
</tr> 
<tr> 
