  ...
  include_once("config.php"); 
   $cashouthdr_idcashouthdr = $_GET['id'];
	$action="add"; 
	$judul="Penambahan Data Pengeluaran Kas Gudang"; 
	$status="Tambah"; 
   $sql = "SELECT IFNULL(max(idcashoutdtl),0)+1  FROM whcashoutdtl";  
   ...
   //   else{   
       ...
       //   		$("#divFormContent").load("cashoutdtl_form.php");   
        //      $("#divFormContent").hide(); 
         ...
         page="whcashoutdtl_form.php?id="+$("input#idcashouthdr").val(); 
	  	$("#divlov").load(page); 
		$("#divlov").show();
...
<td><input type="text" id="dtldesc" name="dtldesc" size="45" maxlength="100" value="<? echo $dtldesc;?>" /></td> 
</tr> 
<tr> 
