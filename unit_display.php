...
and kavling like '%$kav%' and owner like '%$own%' and carabayar like '%$cb%'  
order by  kavling"; 
 } else { 
...
<body>	 
  ...
  <th>Aksi</th> 
 <th>idunit</th>
 <th colspan=2>sektor_idsektor</th>
<th>kavling</th>
<th>tipe</th>
<th>luastanah</th>
<th>Customer</th>
...
<th>Harga</th>
       ...
       <tr> 
       <td width=105px>
      <a href="unit_form.php?action=update&id=<? echo $row['idunit'];?>" class="edit"> <input type="button" class="button" value="Edit"></a>   
       | <a href="unit_process.php?action=delete&id=<? echo $row['idunit'];?>" class="delete"><input type="button" class="button" value="Delete"></a></td>
