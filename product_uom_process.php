<? 
  ...
  $action=$_POST['action']; 
 $qty_uom=$_POST['qty_uom']; 
 $harga_uom=$_POST['harga_uom']; 
 ...
 mysql_query(" insert into product_uom (qty_uom,harga_uom,uom_iduom,product_idproduct)  values  ('$qty_uom','$harga_uom','$uom_iduom','$product_idproduct')")  or die("Data gagal Di Tambahkan!");  
	...
	{ 
$sql = " update product_uom set qty_uom='$qty_uom',harga_uom='$harga_uom',uom_iduom='$uom_iduom',product_idproduct='$product_idproduct' where qty_uom = $qty_uom";  
	...
	{ 
		$id = $_GET['id']; 
		$test = mysql_query("delete from product_uom where qty_uom ='$id'"); 
