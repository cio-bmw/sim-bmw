...
$pdf->SetY($yx);
//buat header tabel//
 $pdf->cell(30,$rh,idcashbook,1,0,'C',0); 
...
$yx =$pdf->getY()+$rh; 
$pdf->SetY($yx);
$sql = " select idcashbook,txndate,txnflag,txnvalue,saldo,txndesc,idcashin,idcashouthdr from cashbook"; 
$result = mysql_query($sql); 
$i=1;  
$no=1;  
$max =21;  
 while($row = mysql_fetch_array($result)) { 
 $pdf->cell(30,$rh,$row['idcashbook'],1,0,'L',0); 
