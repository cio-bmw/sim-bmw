...
function pagination(page){ 
  var cari = $("input#fieldcari").val(); 
    ...
    dataString = 'starting='+page+'&random='+Math.random()+'&supp='+ vsupp +'&startdate='+vstartdate+'&enddate='+venddate+'&dsp='+vdsp;
...
$sql = "select * from receivehdr where supplier_idsupp like '%$idsupp%' and rcv_date between '$startdate' and '$enddate' order by idreceivehdr desc"; 
...
$result = $obj->result; 
?> 
<p class="judul">Daftar Penerimaan Barang</p>	 
