...
<script type="text/javascript" src="js/glhdr.js"></script> 
...
<div id="divSearch"> 
  ...
  <td> 
   <form id="glhdr" method="POST" action="" name="glhdr">  
 Tanggal : <input type="text" size=8 name="startdate" id="startdate" value="<? echo $startdate; ?>" onchange="this.form.submit()"/> 
  s/d : <input type="text" size=8 name="enddate" id="enddate" value="<? echo $enddate; ?>" onchange="this.form.submit()" /> 
   
   
  Cari Data : <select id="pilihcari">  
      <option value="idglhdr">No Jurnal</option> 
      <option value="gl_date">Tanggal</option> 
      <option value="gl_desc">Keterangan</option> 
      <option value="gl_refno">No Ref</option> 
