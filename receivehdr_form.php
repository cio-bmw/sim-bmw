  ...
  include_once("config.php"); 
	...
	$sql0 = "SELECT IFNULL(max(idreceivehdr),0)+1  FROM receivehdr";
...
$(function(){ 
  ...
  $("form#receivehdr_form").submit(function(){ 
   ...
   //   else{   
        	...
        	success:function(response){ 
          	...
          	{  
          	  ...
          	  window.location='receivedtl.php?id='+$("input#idreceivehdr").val();
...
<?php } else {?> 
<tr><td class="right">idreceivehdr</td><td><input type="text" id="idreceivehdr" name="idreceivehdr" size="10" value="<? echo $idreceivehdr;?>" /></td> 
</tr> 
<?php }?> 
<tr> 
