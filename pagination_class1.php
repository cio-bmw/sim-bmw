...
class Pagination_class1{
	...
	var $anchors;
	var $total;
	function Pagination_class1($qry,$starting,$recpage)
	{
		...
		if($previous < 0){
			...
			$anc .= "<li class='next'><a href='javascript:pagination1(0);'>First </a></li>";
			$anc .= "<li class='next'><a href='javascript:pagination1($previous);'>Previous </a></li>";
		}
		...
		for($i=$page_showing; $i>1; $i--){
			...
			$anch = "<li><a href='javascript:pagination1($page);'>$fpreviousPage </a></li>".$anch;
			if($j == $norepeat) break;
			$j++;
		}
		$anc .= $anch;
		...
		for($i=$page_showing; $i<$total_page; $i++){
			...
			$anc .= "<li><a href='javascript:pagination1($page);'>$fnextPage</a></li>";
			if($j==$norepeat) break;
			$j++;
		}
		############################################################
		if($next >= $numrows){
			...
			$anc .= "<li class='next'><a href='javascript:pagination1($next);'>Next </a></li>";
			$anc .= "<li class='next'><a href='javascript:pagination1($last);'>Last</a></li>";
		}
			$anc .= "</ul>";
		$this->anchors = $anc;
