...
function loadData(){ 
  ...
  $.ajax({ 
    url: "groupacc_lov.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
$(function(){  
 ...
 function sendgroupacc(n1,n2) 
 {
     document.getElementById('groupacc_idgroupacc').value=n1;
     document.getElementById('groupacc').value=n2;
 } 
</script> 
...
$fieldcari = $_POST['fieldcari']; 
  ...
  $sql = "select * from groupacc where idgroupacc like '%".$fieldcari."%'";  
...
?> 
	...
	<body> 
	<form method="post" name="groupacc_lov" action="" id="groupacc_lov">  
	<table>  
	<tr><td colspan=5 > 
...
<td><input class="button" type=button value="Pilih" onClick="sendgroupacc('<? echo $row['idgroupacc'];?>','<? echo $row['groupacc'];?>  ' )"></td>
  		<?} //end while ?> 
