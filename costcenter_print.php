...
// membuat header 
printer_draw_text($printer,idcostcenter,$x+10,$y); 
printer_draw_text($printer,costcentername,$x+10,$y); 
...
printer_draw_text($printer,$row['idcostcenter'],$x+10,$y); 
printer_draw_text($printer,$row['costcentername'],$x+10,$y); 
