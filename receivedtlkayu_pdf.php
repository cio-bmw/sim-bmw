...
$pdf->text($x,$yx,'PENERIMAAN BARANG DI GUDANG KAYU');
$pdf->SetFont('helvetica','B',10);
$yx = $pdf->getY()+$rh;$pdf->SetY($yx);$pdf->SetX($x);

$sqlh = "select * from receivehdrkayu where idreceivehdr='$id'"; 
...
$yx =$pdf->getY()+$rh; 
$pdf->SetY($yx);$pdf->SetX($x);
$sql = " select idreceivedtl,product_idproduct,qty,receive_price from receivedtlkayu where receivehdr_idreceivehdr='$id'"; 
