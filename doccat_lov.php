...
function loadData(){ 
  ...
  $.ajax({ 
    url: "doccat_lov.php", //file tempat pemrosesan permintaan (request) 
    type: "GET", 
    data: dataString, 
		success:function(data) 
		{ 
...
$(function(){  
 ...
 function senddoccat(n1,n2) 
 {
     document.getElementById('doccat_iddoccat').value=n1;
     document.getElementById('doccatname').value=n2;
...
$fieldcari = $_POST['fieldcari']; 
  ...
  $sql = "select * from doccat where iddoccat like '%".$fieldcari."%'";  
...
<td><input class="button" type="button" value="Pilih" onClick="senddoccat('<? echo $row['iddoccat'];?>','<? echo $row['doccatname'];?>  ' )"></td>
  		<?} //end while ?> 
